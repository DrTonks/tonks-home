...
for (const file of ['community-emojis.ts','community-image-preview.ts','community-markdown.ts','community-markdown.css','community-articles.ts','community-articles.css','community-overlay.ts']) {
