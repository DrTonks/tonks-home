...
void main() {
  ...
  gl_FragColor = vec4(c, b * b * b * uOpacity);
}
`
...
onMounted(() => {
  ...
  const animate = (t: number) => {
    ...
    currentOpacityRef.value += (p.opacity - currentOpacityRef.value) * 0.05
    uniforms.uOpacity.value = currentOpacityRef.value
